...
import {FilmType, FilmListType, SimilarFilmType, CommentType, PromoFilmType} from '../types/filmType.ts';
...
export const setErrorMessageFilm = createAction<string>('films/setErrorMessage');
